class BookComponent extends HTMLElement {
  constructor() {
    ...
    // Add shadow DOM for encapsulation
    this.attachShadow({ mode: "open" });

    // Initialize HTML template and styles
...
<!-- This creates the preview when a user clicks on a book so far the code runs but need to still work on
the code to fully implement the CSS into the -->
...
<!-- This information provided below is all listed in the CSS file, This is the search overlay
still need to figure out how to code this section -->
